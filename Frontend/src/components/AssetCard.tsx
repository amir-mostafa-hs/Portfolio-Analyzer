  ...
  return (
    ...
    >
      <CardContent className="p-4 md:p-6">
        <div className="flex items-start md:justify-between mb-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-between items-center pt-2 border-t border-primary/10 flex-col md:flex-row">
