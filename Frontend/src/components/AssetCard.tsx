...
const AssetCard = ({ asset, onClick }: AssetCardProps) => {
  ...
  return (
    <Card 
      className={cn(
        "group cursor-pointer transition-all duration-300 hover:shadow-glow hover:border-primary/30",
      ...
      <CardContent className="p-6">
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            ...
            <span className="font-medium">{formatBalance(asset.balance)} {asset.symbol}</span>
          </div>
          ...
          <div className="flex justify-between items-center pt-2 border-t border-primary/10">
            ...
            <span className="font-bold text-lg">{formatPrice(asset.value)}</span>
          </div>
        </div>
