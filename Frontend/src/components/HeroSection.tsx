  ...
  return (
    <div className="relative min-h-screen bg-gradient-hero overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute top-1/3 right-1/4 w-80 h-80 bg-secondary/10 rounded-full blur-3xl animate-float"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute bottom-1/4 left-1/3 w-72 h-72 bg-accent/10 rounded-full blur-3xl animate-float"
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        <div className="text-center mb-16">
          ...
          >
            Track, analyze, and optimize your cryptocurrency investments across
            multiple chains with real-time data, AI-powered insights, and
        ...
        {/* Stats */}
        <div
          className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center animate-fade-in"
